...
VAR
   ...
   ScreenWidth : Word;                                { Screen text width }
   ScreenHeight: Word;                                { Screen text height }
...
procedure DisableTmuxMouse;
begin
  if TmuxMouseEnabled then
  begin
    Write(#27'[?1006l'#27'[?1003l'#27'[?1002l'#27'[?1000l');
    Flush(Output);
...
BEGIN
  If (ButtonCount <> 0) Then
     begin                   { Mouse is available }
      ...
      EnableTmuxMouse;                                  { tmux does not advertise xterm mouse }
